...
namespace Violation_p2.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Name,Subject,Message,Email,Contactdate")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Name,Subject,Message,Email,Contactdate")] Contact contact)
        {
