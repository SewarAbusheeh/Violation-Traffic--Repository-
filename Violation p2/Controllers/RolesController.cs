...
namespace Violation_p2.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoleId,Rolename,RoleCategory")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,Rolename,RoleCategory")] Role role)
        {
            if (id != role.RoleId)
            {
                return NotFound();
