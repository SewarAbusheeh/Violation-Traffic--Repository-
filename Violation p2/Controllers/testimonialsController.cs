...
namespace Violation_p2.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        {
            ViewData["UserId"] = new SelectList(_context.User1s, "User1Id", "User1Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,UserId,Content,Subject,Isapproved")] Testimonial testimonial)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.User1s, "User1Id", "User1Id", testimonial.UserId);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TestimonialId,UserId,Content,Subject,Isapproved")] Testimonial testimonial)
        {
